...
define( 'FGD2WPP_PLUGIN_VERSION', '3.75.5' );
...
function activate_fg_drupal_to_wordpress_premium() {
	require_once plugin_dir_path( __FILE__ ) . 'public/class-fg-drupal-to-wp-redirect.php';
...
add_action('plugins_loaded', 'run_fg_drupal_to_wordpress_premium');
